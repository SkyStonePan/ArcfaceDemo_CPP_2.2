...
#define MERR_ASF_REQUEST_TIMEOUT						(MERR_ASF_BASE_EXTEND+6)		//客户端时间与服务器时间（即北京时间）前后相差在30分钟以上
...
#define MERR_ASF_IMAGEMODE_0_HIGHER_EXT_UNSUPPORT		(MERR_ASF_BASE_EXTEND+11)		//IMAGE模式下不支持全角度(ASF_OP_0_HIGHER_EXT)检测
